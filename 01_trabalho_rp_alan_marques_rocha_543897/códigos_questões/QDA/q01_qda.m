...
%                  Sem a normalização de dados com zscore                %
%----------------------------------------------------------------------- %
...
% Definindo valores de eps para reajuste da matriz de covariância.
...
for eps = eps_values
    ...
    % Calculando a acurácia do modelo QDA
    ...
    title(sprintf('Matriz de Confusão do modelo QDA (EPS = %0.2f)', eps));
