...
%    com validação através da técnica hold-out e PCA com z-score         %
...
n_comp = 7; % Definindo o número desejado de componentes principais
...
fprintf('--------------------------------------------------------\n');
fprintf('Distribuição da variância dos dados nos componentes PCA\n');
fprintf('--------------------------------------------------------\n');
